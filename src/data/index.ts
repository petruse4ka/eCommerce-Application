...
export const ABOUT: About = {
  ...
  MARGO: {
    PersonalText: {
      ...
      description:
        '<p class="mb-2">Маргарита - наш ментор, она же наша муза, она же наш ангел-хранитель, она же верит в нас даже тогда, когда мы сами не знаем, стоит ли верить... Список эпитетов можно продолжать бесконечно, но суть одна:</p><p class="text-bold text-[20px] text-center">«Спасибо, Маргарита!»</p>',
      github: TEAM[3],
    },
    PersonalImageBox: {
