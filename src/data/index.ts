...
export const ABOUT: About = {
  KONSTANTIN: {
    PersonalText: {
      ...
      role: 'Шеф-кондитер',
      description: [
        'Константин – наш бессменный шеф-кондитер и гуру JavaScript! ',
  ...
  OLGA: {
    PersonalText: {
      ...
      description: [
        'Ольга – кондитер-оформитель, мастер эстетики и здравого смысла. ',
  ...
  MARGO: {
    PersonalText: {
      ...
      description: [
        'Маргарита - наш ментор, она же наша муза, она же наш ангел-хранитель!:',
        '«Спасибо, Маргарита!»',
      ],
      github: TEAM[3],
    },
