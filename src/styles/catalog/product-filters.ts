...
export const FILTERS_STYLES = {
  WRAPPER: ['flex', 'flex-col', 'gap-6', 'min-h-[60px]', 'xl:min-h-[150px]'],
  CONTAINER: [
    'hidden',
    'grid',
    'grid-cols-1',
  ...
  FILTERS_TITLE: ['text-lg', 'font-semibold', 'mb-2', 'text-black'],
